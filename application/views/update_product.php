			                ...
			                <div class="col-md-12">
			                    <form action="" method="POST">
	                              ...
	                              <div class="form-group row">
	                                ...
	                                <div class="col-8">
	                                  <input id="lastName" name="lastName" value="" class="form-control here" type="text">
	                                </div>
	                              </div>
	                              <div class="form-group row">
	                                <label for="email" class="col-4 col-form-label">Quantité en stock :</label>
	                                <div class="col-8">
	                                  <input id="email" name="email" value="" class="form-control here" type="text">
	                                </div>
	                              </div>
	                              <div class="form-group row">
                                  <div class="md-form amber-textarea active-amber-textarea col-md-12">
                                    ...
                                    <textarea id="comment" name="comment" value="" placeholder="" class="md-textarea form-control here" rows="3"></textarea>
                                  </div>
	                              </div>
	                              <div class="form-group row">
	                                <label for="yearBirth" class="col-4 col-form-label">Catégorie du produit</label>
	                                <div class="col-8">
																		<input id="yearBirth" name="yearBirth" value="" type="date" class="form-control here" required="required" >
	                                </div>
	                              </div>
